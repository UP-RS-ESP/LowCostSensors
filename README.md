...
Codes are provided in both Python and Arduino, with a detailed equipment profile in each folder. The control unit is either a Raspbery Pi 3B+ or Pi Zero W, but this can be substituted for any other Raspberry Pi or similar device.